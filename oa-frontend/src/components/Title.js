...
export default function Title() {
    ...
    return (
        <div className='w-full h-[32rem] flex flex-col relative justify-center items-center text-center' onMouseEnter={() => setMoved(true)}>
            ...
            <h2 className={`text-lg mt-32 transition-all ${!showTitle && "opacity-0"}`}>
